                                     ...
                                     btScalar mass)
{
  ...
  //btVector3 i[dataSet->GetNumberOfPoints()];
...
bool 	randomizeConstraints = true 
  ...
  //this-> softBody = std:: shared_ptr<btSoftBody>(btSoftBodyHelpers::CreateFromTriMesh(worldInfo, &v[0], &(i[0]), dataSet->GetNumberOfPoints()));
  std::cout << "llegue aca mother   " << this->softBody->getTotalMass() << std::endl;
   std::cout << "llegue aca " << worldInfo.air_density<< std::endl;
  /*
